...
(ag_percept (percept_pobj p1) (percept_pname age) (percept_pval 22))
(ag_percept (percept_pobj p2) (percept_pname age) (percept_pval 30))
(ag_percept (percept_pobj p3) (percept_pname age) (percept_pval 25))
(ag_percept (percept_pobj p4) (percept_pname age) (percept_pval 31))
(ag_percept (percept_pobj p5) (percept_pname age) (percept_pval 25))

(ag_percept (percept_pobj p1) (percept_pname physical) (percept_pval fat))
(ag_percept (percept_pobj p2) (percept_pname physical) (percept_pval fat))
(ag_percept (percept_pobj p3) (percept_pname physical) (percept_pval fat))
(ag_percept (percept_pobj p4) (percept_pname physical) (percept_pval fat))
(ag_percept (percept_pobj p5) (percept_pname physical) (percept_pval fat))
...
(ag_percept (percept_pobj b3) (percept_pname isa) (percept_pval pedestrian))
(ag_percept (percept_pobj b4) (percept_pname isa) (percept_pval pedestrian))
(ag_percept (percept_pobj b5) (percept_pname isa) (percept_pval pedestrian))
...
(ag_percept (percept_pobj b4) (percept_pname partof) (percept_pval ev2))
(ag_percept (percept_pobj b5) (percept_pname partof) (percept_pval ev2))

(ag_percept (percept_pobj b1) (percept_pname gen) (percept_pval f))
(ag_percept (percept_pobj b2) (percept_pname gen) (percept_pval f))
(ag_percept (percept_pobj b3) (percept_pname gen) (percept_pval f))
(ag_percept (percept_pobj b4) (percept_pname gen) (percept_pval m))
(ag_percept (percept_pobj b5) (percept_pname gen) (percept_pval m))


(ag_percept (percept_pobj b1) (percept_pname age) (percept_pval 27))
(ag_percept (percept_pobj b2) (percept_pname age) (percept_pval 30))
(ag_percept (percept_pobj b3) (percept_pname age) (percept_pval 25))
(ag_percept (percept_pobj b4) (percept_pname age) (percept_pval 31))
(ag_percept (percept_pobj b5) (percept_pname age) (percept_pval 25))

(ag_percept (percept_pobj b1) (percept_pname physical) (percept_pval pregnant))
(ag_percept (percept_pobj b2) (percept_pname physical) (percept_pval pregnant))
(ag_percept (percept_pobj b3) (percept_pname physical) (percept_pval fit))
(ag_percept (percept_pobj b4) (percept_pname physical) (percept_pval fit))
(ag_percept (percept_pobj b5) (percept_pname physical) (percept_pval fit))
